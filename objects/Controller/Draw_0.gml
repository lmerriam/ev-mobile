...
//draw_sprite(bg_space, 0, origin_x-(origin_x * multiplier1), origin_y-(origin_y * multiplier1));
//draw_sprite(bg_nebula, 0, origin_x-(origin_x * multiplier2), origin_y-(origin_y * multiplier2));
